...
export const cadeirasData: Cadeira[] = [
  {
    number: 'I',
  ...
  {
    number: 'IX',
    patron: 'Rodolfo Teófilo',
    founder: 'Geraldo Chaves',
    holder: 'Vaga',
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=700&q=80',
    status: 'Vaga',
    patronoBio: 'Rodolfo Teófilo (1853–1932), farmacêutico e escritor cearense, expoente do Naturalismo e autor do clássico "A Fome".',
  },
  {
    number: 'X',
    patron: 'Adolfo Caminha',
    founder: 'Manoel Rodrigues',
    holder: 'João Bosco Ribeiro',
    image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=700&q=80',
    status: 'Titular em exercício',
    posse: '2011',
    bio: 'Ensaísta e historiador regional, especialista nas letras do Vale do Jaguaribe.',
    patronoBio: 'Adolfo Caminha (1867–1897), natural de Aracati, um dos grandes nomes da ficção naturalista brasileira com "Bom-Crioulo".',
  },
  {
    number: 'XI',
    patron: 'Moreira Campos',
    founder: 'Tereza Neuma',
    holder: 'Lúcia de Fátima Castro',
    image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=700&q=80',
    status: 'Titular em exercício',
    posse: '2015',
    bio: 'Contista premiada e professora de literatura brasileira.',
    patronoBio: 'Moreira Campos (1914–1994), mestre do conto na literatura brasileira contemporânea.',
  },
  {
    number: 'XII',
